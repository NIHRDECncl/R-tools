...
ui<-fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      textInput(inputId = "DxTestName", label = "Name of test", value = "NT-proBNP <11 men, <17 women"),
      numericInput("prevalence", "prior probability (prevalence)", min=0, max=1, value=0.235, step = 0.01),
      numericInput("n", "population", min=1, max=1000, value=345),
      numericInput("sensitivity", "sensitivity of index test", min=0, max=1, value= 0.95, step = 0.01),
      numericInput("specificity", "specificity of index test", min=0, max=1, value= 0.68, step = 0.01),
