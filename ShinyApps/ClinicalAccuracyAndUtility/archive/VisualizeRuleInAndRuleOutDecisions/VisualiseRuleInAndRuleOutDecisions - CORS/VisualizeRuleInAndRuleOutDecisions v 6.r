...
#==========================================================
  ...
  linesPre2PostProb <- eventReactive(input$GoButton, {
    ...
    data.frame(
      ...
      PostProbNegYciU = c(Dx$TNY_ciL, Dx$TNY_ciL)
    )
  })
  ...
  output$PrePostProb<-renderPlot({
    ggplot(graphPre2PostProb()) +
      ...
      # geom_ribbon(data = linesPre2PostProb(), aes(x = linesPre2PostProb()$x,
      #                                         ymin = linesPre2PostProb()$PostProbPosNciL,
      #                                         ymax = linesPre2PostProb()$PostProbPosNciU, alpha = 0.03), fill  = "darkseagreen3") +
